...
No rows were removed due to missing data; all records were retained for analysis.

---

## Exploratory Data Analysis (EDA)
EDA focused on understanding relationships between risk factors and lung cancer diagnosis.

Key components:
- Frequency distributions of binary variables
- Age distribution stratified by diagnosis
- Pairwise comparisons between smoking, alcohol use, exercise, and diagnosis
- Correlation analysis for binary predictors
